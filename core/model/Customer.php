...
if( !class_exists( 'ShoppCustomer' ) ) {
  class ShoppCustomer extends ShoppDatabaseObject {
    ...
    public function load_downloads() {
      ...
      !( $purchases = shopp_customer_orders( $this->id ) )
      ) return; // Decomment before commit!
...
if( !class_exists( 'CustomersExport' ) ) {
...
if( !class_exists( 'CustomersTabExport' ) ) {
...
if( !class_exists( 'CustomersCSVExport' ) ) {
...
if( !class_exists( 'CustomersXLSExport' ) ) {
